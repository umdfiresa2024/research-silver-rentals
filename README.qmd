...
```{r}
# Create a map of the treated and untreated group
...
png(filename="images/treated_untreated_map.png", width=800, height=600)
...
# Overlay zip codes for treated areas
...
# Overlay zip codes for untreated areas
